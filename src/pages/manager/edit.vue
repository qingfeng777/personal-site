<template>
        <div >
                  ...
                  <div class="col-lg-6">
                    <div class="input-group">
                      ...
                      <div class="input-group-btn">
                        <button type="button" class="btn btn-primary btn-lg selectBtn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">可选项 </button>
            ...
            <img class="thumb" data-original="../../assets/images/201610181739277776.jpg" src="../../assets/images/201610181739277776ed.jpg" alt="以柔布棋局" style="display: block;">
